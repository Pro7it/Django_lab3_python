...
const PlayCreatePage: React.FC = () => {
  ...
  const except = ["actors", "directors", "play_id", "image"];
  ...
  const handleCreate = () => {
    if (data) {
      ...
      if (checkAllFilled(data, EmptyPlay, except)) {
        postQuery(`api/plays/`, Data).then((r) =>
          r
            ? (setData(EmptyPlay),
    ...
    <>
      ...
      <Container containerSize="fullwindow" template="outer">
        <Container
          ...
          props={{ style: { justifyItems: "start", paddingTop: 0 } }}
        >
          {/* title */}
          <EditableField
            size="h1"
          ...
          <Space direction="vertical" size="middle" style={{ width: "100%" }}>
              ...
              <Space size="middle" style={{ alignItems: "start" }}>
                ...
                <EditableField
                  ...
                  textarea={{
                    ...
                    value: data.author,
                    onChange: (v) =>
                      changeField(v.currentTarget.value, "author", setData),
                  }}
                />
                {/* duration */}
                <ClockCircleOutlined
            ...
            <EditableField
              textarea={{
                ...
                onChange: (v) =>
                  changeField(v.currentTarget.value, "description", setData),
              }}
            />
          </Space>
          {checkAllFilled(data, EmptyPlay, except) && (
            <Space
